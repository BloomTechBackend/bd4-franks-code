...
public class MemberDao {
    ...
    public void deletePermanently(String memberId) {
        Member aMember = new Member();   // Instantiate an object to be used in the delete
        aMember.setId(memberId);         // Set the memberId to the id of who is supposed to be deleted
        mapper.delete(aMember);          // Use DynamoDB mapper to delete (tell DynamoDB to delete)
    }
}
