...
public class CheckUserInGroupActivity {
    // Changed to use the caching dao we set up
    //private final GroupMembershipDao groupMembershipDao;       // non-caching Dao reference
    private final GroupMembershipCachingDao groupMembershipDao;  // caching Dao reference
