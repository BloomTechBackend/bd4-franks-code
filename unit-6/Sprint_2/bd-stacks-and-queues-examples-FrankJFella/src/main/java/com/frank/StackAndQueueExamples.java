 ...
 *
 *  Java will allow Stack access in non-LIFO manner - THIS CAN BE CONFUSING!
 *
 ...
 *  .remove(index)    - remove element at index given - Non-LIFO - violation of Stack concept
 ...
 *  .get(index)       - return element at the index given - Non-LIFO - violation of Stack concept
 *  .elementAt(index) - same as get(index) - Non-LIFO - violation of Stack concept
 ...
 **********************************************************************************/
 ...
 //                              new Stack();   // - OK too
		...
		//                     processes in entry-sequence NOT LIFO sequence
		...
		// .search() returns the position in the Stack using LIFO
		// Note: This next statement will produce an unexpected result....
		// get(index) retreive the element at that index - index start at the top using entry sequence
 ...
 *                            and remove from the data structure
 *
 *  Normal access to a Queue is performed using: .push() ond .poll()
 *
 *  Some methods:
 *  
 *  .push(object)     - add element to end of Queue - Exception thrown is element cannot be added
 ...
 **********************************************************************************/
		...
		itemNum = 0;
		// Since a for-each process in entry sequence, which is FIFO
		//       is OK to use with QUEUE
		//       for-each does NOT remove element from queue - violation of FIFO Queue structure
