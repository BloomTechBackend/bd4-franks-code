...
public class InversionConverter implements PrimePhotoConverter {
    ...
    public String convert(final PrimePhoto image, final String imageName) {
        ...
        for (Pixel pixel : image.getPixels()) {
            ...
            // rgb.invert();   // replaced due to immutable version of invert() returning a new object
                               // rather than changing the values in the existing object
            rgb = rgb.invert();// take the values in our rgb object and return an new rgb object with inverted values
